...
import { CreateUserDto, UpdateEmailUserDto, UpdatePasswordDto } from '../dtos/user.dto'
...
export class UsersService {
  ...
  async updatePassword(id: string, payload: UpdatePasswordDto) {
    ...
    const isMatchPassword: boolean = await bcrypt.compare(payload.password, user.password)

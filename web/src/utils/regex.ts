export const NAMES_REGEX: RegExp = /^[A-ZÑa-zñáéíóúÁÉÍÓÚ'°][A-ZÑa-zñáéíóúÁÉÍÓÚ'°]{2,22}(?: [A-ZÑa-zñáéíóúÁÉÍÓÚ'°][A-ZÑa-zñáéíóúÁÉÍÓÚ'°]{2,22})?$/
...
export const PWD_REGEX: RegExp = /^(?=.*[a-z])(?=.*[0-9]).{8,30}$/

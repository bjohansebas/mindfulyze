...
export default function SignUp() {
  return (
    <div className="z-10 h-fit w-full max-w-md overflow-hidden rounded-2xl border shadow-xl">
      <div className="flex flex-col items-center justify-center gap-2 border-b bg-background px-4 py-6 pt-8 text-center sm:px-16">
        ...
        <h1 className="mt-4 text-balance font-semibold text-emerald-600 text-xl">Create your Mindfulyze account</h1>
        <h2 className="text-balance text-sm">Start writing about your daily life.</h2>
      </div>
